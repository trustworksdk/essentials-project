...
public abstract class AbstractSingleOperationTransactionDurableLocalCommandBusIT<DURABLE_QUEUES extends DurableQueues>
    ...
    protected final DURABLE_QUEUES createDurableQueues(JdbiUnitOfWorkFactory unitOfWorkFactory) {
        return createDurableQueues(unitOfWorkFactory,
