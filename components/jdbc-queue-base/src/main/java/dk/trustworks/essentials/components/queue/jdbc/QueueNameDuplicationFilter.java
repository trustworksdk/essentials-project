...
/**
 * Custom filter to extract the "queue_name" property from JSON change notifications.<br>
 * This filter is useful when dealing with multiple notifications involving the same queue.<br>
 ...
 * the queue implementation with 100 {@link TableChangeNotification}'s. Using the {@link QueueNameDuplicationFilter} it
