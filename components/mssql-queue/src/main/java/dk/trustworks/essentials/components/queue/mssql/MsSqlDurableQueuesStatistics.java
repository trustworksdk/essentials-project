 ...
 * The {@link MsSqlDurableQueuesStatistics} component will
...
public class MsSqlDurableQueuesStatistics implements DurableQueuesStatistics {
    private static final Logger log                               = LoggerFactory.getLogger(MsSqlDurableQueuesStatistics.class);
    ...
    private class QueueStatisticsMessageRowMapper implements RowMapper<QueuedStatisticsMessage> {
        ...
        public QueuedStatisticsMessage map(ResultSet rs, StatementContext ctx) throws SQLException {
            ...
            if (metaDataColumnValue != null) {
                messageMetaData = MsSqlDurableQueuesStatistics.this.deserializeMessageMetadata(queueName, metaDataColumnValue);
            } else {
