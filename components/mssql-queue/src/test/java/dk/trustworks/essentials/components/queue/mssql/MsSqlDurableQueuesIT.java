 ...
 */
@Testcontainers
abstract class MsSqlDurableQueuesIT extends DialectDurableQueuesITBase<MsSqlDurableQueues> {
    ...
    @Override
    protected MsSqlDurableQueues createDialectDurableQueues(JdbiUnitOfWorkFactory unitOfWorkFactory,
