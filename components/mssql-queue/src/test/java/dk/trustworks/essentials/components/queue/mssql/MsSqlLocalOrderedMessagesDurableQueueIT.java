 ...
 */
@Testcontainers
abstract class MsSqlLocalOrderedMessagesDurableQueueIT extends LocalOrderedMessagesDurableQueueIT<MsSqlDurableQueues, GenericHandleAwareUnitOfWork, JdbiUnitOfWorkFactory> {
    @Container
