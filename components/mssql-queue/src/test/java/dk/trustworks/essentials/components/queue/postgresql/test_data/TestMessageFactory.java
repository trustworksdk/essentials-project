...
public class TestMessageFactory {
     ...
     */
    public static Map<QueueName, List<Message>> createUnorderedMessages(int totalMessages,
     ...
     */
    public static Map<QueueName, List<OrderedMessage>> createOrderedMessages(int totalMessages,
