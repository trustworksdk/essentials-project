...
import dk.trustworks.essentials.components.queue.mssql.*;
...
public class CentralizedFetcherDurableQueueIT_WithOrderedUnordered {
    @Container
    private final MSSQLServerContainer<?> msSQLContainer = dk.trustworks.essentials.components.queue.mssql.MsSqlTestContainerSupport.createMsSqlContainer();
    ...
    private MsSqlDurableQueues    durableQueues;
    ...
    void setup() {
        ...
        durableQueues = MsSqlDurableQueues.builder()
