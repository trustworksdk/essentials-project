 ...
 */
@Testcontainers
abstract class MsSqlLocalOrderedMessagesRedeliveryDurableQueueIT extends LocalOrderedMessagesRedeliveryDurableQueueIT<MsSqlDurableQueues, GenericHandleAwareUnitOfWork, JdbiUnitOfWorkFactory> {
    @Container
    protected final MSSQLServerContainer<?> postgreSQLContainer = dk.trustworks.essentials.components.queue.mssql.MsSqlTestContainerSupport.createMsSqlContainer();
