...
public final class MsSqlTestContainerSupport {
    private MsSqlTestContainerSupport() {
    }

    public static MSSQLServerContainer<?> createMsSqlContainer() {
        ...
        return new MSSQLServerContainer<>("mcr.microsoft.com/mssql/server:2022-latest")
                ...
                .withMinimumRunningDuration(Duration.ofSeconds(15))
