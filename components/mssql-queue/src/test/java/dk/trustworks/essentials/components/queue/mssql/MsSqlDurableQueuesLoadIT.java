...
import dk.trustworks.essentials.components.queue.jdbc.test.AbstractCentralizedToggleDurableQueuesLoadIT;
 ...
 */
@Testcontainers
abstract class MsSqlDurableQueuesLoadIT extends AbstractCentralizedToggleDurableQueuesLoadIT<MsSqlDurableQueues> {
    @Container
