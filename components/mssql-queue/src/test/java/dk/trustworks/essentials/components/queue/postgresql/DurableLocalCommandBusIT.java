 ...
 */
@Testcontainers
public abstract class DurableLocalCommandBusIT extends AbstractDurableLocalCommandBusIT<MsSqlDurableQueues, GenericHandleAwareUnitOfWorkFactory.GenericHandleAwareUnitOfWork, JdbiUnitOfWorkFactory> {
    @Container
