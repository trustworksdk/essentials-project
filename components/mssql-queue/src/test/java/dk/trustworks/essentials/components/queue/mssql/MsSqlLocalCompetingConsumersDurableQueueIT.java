 ...
 */
@Testcontainers
abstract class MsSqlLocalCompetingConsumersDurableQueueIT extends LocalCompetingConsumersDurableQueueIT<MsSqlDurableQueues, GenericHandleAwareUnitOfWork, JdbiUnitOfWorkFactory> {
    @Container
