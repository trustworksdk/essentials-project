 ...
 */
@Testcontainers
abstract class SingleOperationTransactionMsSqlLocalCompetingConsumersDurableQueueIT extends LocalCompetingConsumersDurableQueueIT<MsSqlDurableQueues, GenericHandleAwareUnitOfWorkFactory.GenericHandleAwareUnitOfWork, JdbiUnitOfWorkFactory> {
    @Container
