 ...
 * </ul>
 */
public final class NextGenListener implements Lifecycle, AutoCloseable {
    private static final Logger log = LoggerFactory.getLogger(NextGenListener.class);

    public static final String CHANNEL = "ng_wakeup";
     ...
     */
    public NextGenListener(DataSource dataSource, Map<String, ShardWakeup> wakeups) {
    ...
    public void start() {
        ...
        thread = new Thread(this::listen, "ng-listener");
