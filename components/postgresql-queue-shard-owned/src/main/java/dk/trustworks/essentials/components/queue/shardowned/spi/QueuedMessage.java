 ...
 * @param visibleAt when it becomes eligible for delivery — now or earlier for a ready message, in the
 *                  future for one waiting out a retry backoff or an enqueue delay
 */
