...
class NextGenRebalanceIT {
    ...
    private static final ShardOwnerSettings FAST = new ShardOwnerSettings(
            ...
            Duration.ofMillis(300), Duration.ofMillis(100), 1_000, 200L, 8, Duration.ofMillis(50), Duration.ofSeconds(30), 512, 2, Duration.ofSeconds(5));
