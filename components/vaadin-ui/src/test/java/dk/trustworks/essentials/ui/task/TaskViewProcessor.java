...
import dk.trustworks.essentials.ui.task.domain.events.CommentAdded;
import dk.trustworks.essentials.ui.task.domain.events.TaskCompleted;
...
@Service
public class TaskViewProcessor extends ViewEventProcessor {

    private Logger logger = LoggerFactory.getLogger(TaskViewProcessor.class);

    public Map<String, TaskView> taskViews = new ConcurrentHashMap<>();

    public TaskViewProcessor(ViewEventProcessorDependencies viewEventProcessorDependencies) {
        super(viewEventProcessorDependencies);
    }

    @Override
    public String getProcessorName() {
        return "TaskViewProcessor";
    }
