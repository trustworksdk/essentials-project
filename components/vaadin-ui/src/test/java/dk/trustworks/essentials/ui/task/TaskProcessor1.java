...
@Service
public class TaskProcessor1 extends EventProcessor {

    private final Logger logger = LoggerFactory.getLogger(TaskProcessor1.class);

    public Map<String, TaskView> taskViews = new ConcurrentHashMap<>();

    public TaskProcessor1(EventProcessorDependencies eventProcessorDependencies) {
        super(eventProcessorDependencies);
    }

    @Override
    public String getProcessorName() {
        return "TaskProcessor1";
    }
