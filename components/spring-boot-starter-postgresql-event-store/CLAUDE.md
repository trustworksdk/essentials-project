...
- **Jackson config** — `JSONEventSerializer` disables getter/setter visibility; uses field + creator visibility only. Adding `com.fasterxml.jackson.databind.Module` beans auto-registers them.
