...
public class CachingAggregateSnapshotRepositoryProvider implements AggregateSnapshotRepositoryProvider {
    ...
    public Optional<AggregateSnapshotRepository> resolve(AggregateType aggregateType,
        ...
        return cache.computeIfAbsent(cacheKey(aggregateType, aggregateImplementationType),
                                     ignored -> factory.create(aggregateType, aggregateImplementationType));
    }
