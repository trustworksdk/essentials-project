...
- `fetchNextBatchOfMessages` (per-queue fetching)
- `fetchNextBatchOfMessagesBatched` (single-query batched fetching + dedup)

Implementation: `components/postgresql-queue/src/test/java/dk/trustworks/essentials/components/queue/postgresql/QueueFetchStrategyBenchmarkIT.java`
