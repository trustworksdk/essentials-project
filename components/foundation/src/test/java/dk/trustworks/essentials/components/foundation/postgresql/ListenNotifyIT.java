...
class ListenNotifyIT {
    ...
    void setup() {
        ...
        // The container is shared by every test in this class, so the table survives between test methods - drop it first.
        jdbi.useTransaction(handle -> handle.execute("DROP TABLE IF EXISTS " + TABLE_NAME));
