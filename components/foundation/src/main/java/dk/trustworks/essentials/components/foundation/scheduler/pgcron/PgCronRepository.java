 ...
 * validate {PgCronJob#cronExpression} and {PgCronJob#function} an initial layer of defense against SQL injection by applying naming conventions intended to reduce the risk of malicious input.<br>
 ...
 * Insufficient attention to these practices may leave the application vulnerable to SQL injection, potentially endangering the security and integrity of the database.<br>
 * <br>
 * It is highly recommended that the {PgCronJob#cronExpression} and {PgCronJob#function} value is only derived from a controlled and trusted source.<br>
 * To mitigate the risk of SQL injection attacks, external or untrusted inputs should never directly provide the {PgCronJob#cronExpression} and {PgCronJob#function} values.<br>
 */
public class PgCronRepository {
    ...
    public Integer schedule(PgCronJob job) {
        ...
        String functionName   = job.function();
