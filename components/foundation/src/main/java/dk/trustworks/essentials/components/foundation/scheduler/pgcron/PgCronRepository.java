 ...
 * <b>It is the responsibility of the user of this component to sanitize the {@link  PgCronJob#cronExpression()}, {@link  PgCronJob#functionName()} and  {@link  PgCronJob#args()}
 * to ensure the security of all the SQL statements generated by this component.</b><br>
 * The {@link PgCronRepository} component will attempt to validate {@link  PgCronJob#functionName()} using {@link PostgresqlUtil#isValidFunctionName(String)} as an initial layer
 ...
 * To mitigate the risk of SQL injection attacks, external or untrusted inputs should never directly provide the {@link PgCronJob#cronExpression()}, {@link  PgCronJob#functionName()} and  {@link PgCronJob#args()} values.
 */
public class PgCronRepository {
     ...
     * This method queries the {@value #PG_CRON_JOB_TABLE_NAME} table using the
     ...
     *
     * @return the count of entries in the {@value #PG_CRON_JOB_TABLE_NAME} table as a {@code long}
     */
    ...
    /**
     * Retrieves a paginated list of PostgreSQL cron job run details from table {@value #PG_CRON_JOB_DETAILS_TABLE_NAME} for a specific job ID.
     ...
     */
    public record PgCronJobRunDetails(
            Integer jobId,
            Integer runId,
            Integer jobPid,
            String database,
