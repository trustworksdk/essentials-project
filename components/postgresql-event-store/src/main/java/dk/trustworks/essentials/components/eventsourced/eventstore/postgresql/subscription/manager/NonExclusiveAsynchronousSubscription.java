...
public class NonExclusiveAsynchronousSubscription implements EventStoreSubscription {
    ...
    public void start() {
        if (!started) {
            ...
            eventStoreSubscriptionObserver.resolveResumePoint(resumePoint,
                                                              onFirstSubscriptionSubscribeFromAndIncludingGlobalOrder,
                                                              EventStoreSubscriptionManager.DefaultEventStoreSubscriptionManager.NonExclusiveAsynchronousSubscription.this,
                                                              resolveResumePointTiming.stop().getDuration());

            subscription = new EventStoreSubscriptionManager.DefaultEventStoreSubscriptionManager.PersistedEventSubscriber(eventHandler,
                                                                                                                           this,
