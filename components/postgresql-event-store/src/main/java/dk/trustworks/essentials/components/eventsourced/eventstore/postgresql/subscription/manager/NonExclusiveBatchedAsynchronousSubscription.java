...
public class NonExclusiveBatchedAsynchronousSubscription implements EventStoreSubscription {
    ...
    public void start() {
        if (!started) {
            ...
            eventStoreSubscriptionObserver.resolveResumePoint(resumePoint,
                                                              onFirstSubscriptionSubscribeFromAndIncludingGlobalOrder,
                                                              EventStoreSubscriptionManager.DefaultEventStoreSubscriptionManager.NonExclusiveBatchedAsynchronousSubscription.this,
