...
public class DefaultEventStoreSubscriptionManager implements EventStoreSubscriptionManager {
    ...
    public DefaultEventStoreSubscriptionManager(EventStore eventStore,
                                                EventStoreSubscriptionSettings eventStoreSubscriptionSettings,
        ...
        requireTrue(eventStoreSubscriptionSettings.eventStorePollingBatchSize() >= 1, "eventStorePollingBatchSize must be >= 1");
        this.eventStore = requireNonNull(eventStore, "No eventStore provided");
        this.eventStorePollingBatchSize = eventStoreSubscriptionSettings.eventStorePollingBatchSize();
        this.eventStorePollingInterval = requireNonNull(eventStoreSubscriptionSettings.eventStorePollingInterval(), "No eventStorePollingInterval provided");
        ...
        this.snapshotResumePointsEvery = requireNonNull(eventStoreSubscriptionSettings.snapshotResumePointsEvery(), "No snapshotResumePointsEvery provided");
    ...
    public EventStoreSubscriptionSettings getEventStoreSubscriptionSettings() {
        return eventStoreSubscriptionSettings;
    }
    ...
    public EventStoreSubscription exclusivelySubscribeToAggregateEventsAsynchronously(SubscriberId subscriberId,
        ...
        return addEventStoreSubscription(subscriberId,
                                         ...
                                         new ExclusiveAsynchronousSubscription(eventStore,
                                                                               ...
                                                                               eventHandler,
                                                                               eventStoreSubscriptionObserver,
                                                                               eventStoreSubscriptionSettings));
    }
