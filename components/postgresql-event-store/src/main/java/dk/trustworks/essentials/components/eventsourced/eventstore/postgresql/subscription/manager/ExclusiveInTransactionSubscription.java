...
public class ExclusiveInTransactionSubscription implements EventStoreSubscription {
    private static final Logger     log = LoggerFactory.getLogger(ExclusiveInTransactionSubscription.class);
                                  ...
                                  .forEach(event -> {
                                      ...
                                      try {
                                          ...
                                          eventStoreSubscriptionObserver.handleEvent(event,
                                                                                     eventHandler,
                                                                                     EventStoreSubscriptionManager.DefaultEventStoreSubscriptionManager.ExclusiveInTransactionSubscription.this,
