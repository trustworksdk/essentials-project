...
public record ApiCdcConfiguration(
    ...
    public static ApiCdcConfiguration from(boolean enabled,
        ...
        return new ApiCdcConfiguration(
                ...
                cdcProperties.getWal2JsonTailer().getPollInterval().toString(),
                cdcProperties.getWal2JsonTailer().getPollBackoffInterval().toString(),
                cdcProperties.getWal2JsonTailer().getMaxPollBackoffInterval().toString(),
                cdcProperties.getWal2JsonTailer().getReplicationStatusInterval().toString(),
