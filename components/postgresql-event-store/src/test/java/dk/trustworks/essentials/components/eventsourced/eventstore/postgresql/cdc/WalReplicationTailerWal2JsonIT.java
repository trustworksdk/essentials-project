...
@Testcontainers
public class WalReplicationTailerWal2JsonIT extends AbstractLogicalReplicationPostgresIT {
    ...
    void retries_after_transient_inbox_failure_and_eventually_persists() {
        ...
        var handler = new WalReplicationTailerErrorHandler() {
            @Override
    ...
    void perf_500_inserts_throughput_and_latency_based_on_inbox_payloads() {
        ...
        System.out.println("""
                           WalReplicationTailer wal2json PERF RESULT (from inbox)
                           --------------------------------------
                           rows               = %d
                           totalSeconds       = %.2f
