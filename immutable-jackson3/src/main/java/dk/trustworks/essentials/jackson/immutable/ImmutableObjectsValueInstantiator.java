...
public final class ImmutableObjectsValueInstantiator extends ValueInstantiator {
    ...
    @Override
    public ValueInstantiator createContextual(DeserializationContext context, BeanDescription.Supplier beanDesc) {
        return new ImmutableObjectsValueInstantiator(typeToInstantiate, standardJacksonValueInstantiator.createContextual(context, beanDesc));
    }
