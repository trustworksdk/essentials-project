...
This module enables automatic JSON serialization and deserialization for all `SingleValueType` implementations using [Jackson (FasterXML)](https://github.com/FasterXML/jackson (Jackson 2) and tools.jackson (Jackson 3)).
