 ...
 * {@link NumberType} subclasses fall through to Jackson's own creator detection.
 * <p>
 ...
 * used to be the obvious workaround; {@link NumberTypeCreatorPrecisionTest} pins why that
...
class NumberTypeCreatorRequirementTest {
    ...
    @Test
    void test_a_value_typed_creator_alone_reads_every_numeric_token()  {
    ...
    @Test
    void test_a_decimal_is_read_at_full_precision_rather_than_through_a_double()  {
    ...
    @Test
    void test_the_shipped_BigDecimalType_subclasses_read_every_numeric_token()  {
    ...
    @Test
    void test_a_concrete_types_own_validation_still_runs()  {
    ...
    class QuotedNumbersStillRead {
        @Test
        void test_a_quoted_number_reads_into_every_family()  {
            assertThat(objectMapper.readValue("\"2\"", Amount.class).value()).isEqualByComparingTo("2");
            assertThat(objectMapper.readValue("\"2.5\"", Amount.class).value()).isEqualByComparingTo("2.5");
    ...
    class AllNumberTypeBasesRoundTrip {
        @Test
        void test_each_base_reads_its_own_width()  {
            assertThat(objectMapper.readValue("2", PlainBigInteger.class).value()).isEqualTo(BigInteger.TWO);
