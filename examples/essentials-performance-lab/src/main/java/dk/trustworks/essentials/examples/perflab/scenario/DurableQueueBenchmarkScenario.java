...
public class DurableQueueBenchmarkScenario implements LabScenario {
    ...
    public String description() {
        return "Placeholder for ordered/unordered durable queue throughput and latency benchmark with variable queue and consumer topology";
    }

    @Override
    public void run(EssentialsPerformanceLabProperties properties) {
        log.info("Scenario '{}' is scaffolded and ready for implementation. Suggested first matrix: queueCount={}, producerThreads={}, subscriberCount={}.",
                 name(),
