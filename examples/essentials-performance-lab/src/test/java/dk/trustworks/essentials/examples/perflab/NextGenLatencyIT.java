...
class NextGenLatencyIT {
    private static final Logger log = LoggerFactory.getLogger(NextGenLatencyIT.class);
    ...
    private LatencyRecorder.Summary measure(boolean localHandoff) throws Exception {
        ...
        try (var queue = new NextGenQueue(dataSource, QUEUE_ID, SHARD_COUNT, "latency")) {
