...
/**
 * Identifies a shipping order, and is also the {@code @Id} of the {@code ShippingOrder} document.
 *
 * <p>A semantic type rather than a bare {@code String}, so it cannot be swapped with any other identifier by mistake.
 * {@code Application} registers it with {@code AdditionalCharSequenceTypesSupported} so Spring Data MongoDB stores it
 * as a plain string.
 *
