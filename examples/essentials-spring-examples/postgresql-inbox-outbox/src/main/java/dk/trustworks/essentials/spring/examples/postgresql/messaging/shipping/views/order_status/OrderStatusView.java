 ...
 * to expose it, and a closed projection means the query never even selects those columns.
 * <p>
 * {@code getId()} is a {@code String} rather than an {@code OrderId} because the entity's {@code @Id} is - see the
 * bounded context's {@code CLAUDE.md} for why that is deliberate here and not in the MongoDB sibling.
 */
