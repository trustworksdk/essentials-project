...
/**
 * The API file of the {@code brokerage.request_clearing} slice (rules/slice-design.md &sect;R2).
 * <p>
...
public class RequestClearingAPI {
    private final CommandBus commandBus;

    public RequestClearingAPI(CommandBus commandBus) {
        this.commandBus = requireNonNull(commandBus, "No commandBus provided");
    }

    @PostMapping("/{settlementId}/clearing-requests")
    public void requestClearing(@PathVariable SettlementId settlementId) {
