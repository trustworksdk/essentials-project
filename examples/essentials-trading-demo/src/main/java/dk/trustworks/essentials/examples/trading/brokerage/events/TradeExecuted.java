...
/**
 * The trade has been executed on the market. Settlement may not be requested before this has been recorded.
 */
public record TradeExecuted(TradeId tradeId) implements TradeEvent {
