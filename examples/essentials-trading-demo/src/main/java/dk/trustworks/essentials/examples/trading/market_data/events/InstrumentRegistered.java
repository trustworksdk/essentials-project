...
/**
 * An instrument has been registered as tradeable. The first event in every {@code Instrument} stream, and the one that
 * establishes the instrument's existence.
 */
public record InstrumentRegistered(InstrumentId instrumentId,
                                   Symbol symbol,
                                   String displayName) implements InstrumentEvent {
    public InstrumentRegistered {
