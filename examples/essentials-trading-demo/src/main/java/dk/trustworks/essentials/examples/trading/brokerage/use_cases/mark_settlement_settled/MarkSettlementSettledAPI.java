...
/**
 * The API file of the {@code brokerage.mark_settlement_settled} slice (rules/slice-design.md &sect;R2).
 * <p>
...
public class MarkSettlementSettledAPI {
    private final CommandBus commandBus;

    public MarkSettlementSettledAPI(CommandBus commandBus) {
        this.commandBus = requireNonNull(commandBus, "No commandBus provided");
    }

    @PostMapping("/{settlementId}/settlement")
    public void markSettled(@PathVariable SettlementId settlementId) {
