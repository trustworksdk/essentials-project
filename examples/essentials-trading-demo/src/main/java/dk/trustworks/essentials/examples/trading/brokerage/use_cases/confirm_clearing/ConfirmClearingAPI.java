...
/**
 * The API file of the {@code brokerage.confirm_clearing} slice (rules/slice-design.md &sect;R2).
 * <p>
...
public class ConfirmClearingAPI {
    private final CommandBus commandBus;

    public ConfirmClearingAPI(CommandBus commandBus) {
        this.commandBus = requireNonNull(commandBus, "No commandBus provided");
    }

    @PostMapping("/{settlementId}/clearing-confirmations")
    public void confirmClearing(@PathVariable SettlementId settlementId) {
