...
/**
 * The API file of the {@code brokerage.reconcile_settlement} slice (rules/slice-design.md &sect;R2).
 * <p>
...
public class ReconcileSettlementAPI {
    private final CommandBus commandBus;

    public ReconcileSettlementAPI(CommandBus commandBus) {
        this.commandBus = requireNonNull(commandBus, "No commandBus provided");
    }

    @PostMapping("/{settlementId}/reconciliation")
    public void reconcile(@PathVariable SettlementId settlementId) {
