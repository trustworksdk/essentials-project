...
/**
 * Ask for the settlement to be sent to clearing -- the first step of its post-trade lifecycle.
 *
 * <p>Both the command dispatched on the {@code CommandBus} and, when the endpoint builds it from its path variable,
 * the payload of {@code POST /api/admin/settlements/{settlementId}/clearing-requests}.
 *
 * <p>Repeating it is a no-op; issuing it against a closed settlement throws.
 */
public record RequestClearing(SettlementId settlementId) {
    public RequestClearing {
