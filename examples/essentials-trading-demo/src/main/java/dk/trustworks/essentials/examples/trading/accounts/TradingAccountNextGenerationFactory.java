...
/**
 * Defines what state a trading account carries into its next books generation.
 */
@Component
public class TradingAccountNextGenerationFactory implements TypedClosingBooksNextGenerationFactory<TradingAccountId, TradingAccountGenerationId, TradingAccount, String> {
    @Override
