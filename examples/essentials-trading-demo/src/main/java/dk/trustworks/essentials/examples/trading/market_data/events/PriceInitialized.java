...
/**
 * The first price ever recorded for an instrument. The first event in every {@code InstrumentPrice} stream.
 */
public record PriceInitialized(InstrumentId instrumentId,
                               Amount price) implements InstrumentPriceEvent {
    public PriceInitialized {
