...
/**
 * Clearing has been confirmed. Only after this may the settlement be marked settled.
 */
public record ClearingConfirmed(SettlementId settlementId) implements SettlementEvent {
    public ClearingConfirmed {
