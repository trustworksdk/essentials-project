...
/**
 * Sell this product at a different price from now on. Imperative name, because a command is a request that can
 * still be refused - unlike the event it may produce.
 */
