...
/**
 * The customer presses "place order". The command carries nothing but the id: everything the decision needs is
 * already in the stream.
 */
data class PlaceOrder(override val id: OrderId) : OrderCommand
